...
module regfile_elab_top (
    ...
    output logic [31:0] read2_data_o,
    output logic [31:0] read3_data_o,
  ...
  assign read1_data_o = read1.data;
  assign read2_data_o = read2.data;
  assign read3_data_o = read3.data;

  assign write.addr = reg_addr_e'(write_addr_i);
  assign write.data = write_data_i;
  assign write.write_en = write_en_i;
